...
EXAMPLE - Create a currency field:
{
  ...
  "options": { "symbol": "$", "precision": 2 }
    ...
    inputSchema: {
      ...
      required: ['baseId', 'tableIdOrName', 'name', 'type'],
      additionalProperties: false,
    },
  },
  {
...
EXAMPLE:
{
  ...
  "description": "Current status of the task"
    ...
    inputSchema: {
      ...
      required: ['baseId', 'tableIdOrName', 'fieldIdOrName'],
      additionalProperties: false,
    },
  },
  {
...
EXAMPLE:
{
  ...
  "recordIds": [
    ...
    inputSchema: {
      ...
      required: ['baseId', 'tableName', 'recordIds'],
      additionalProperties: false,
    },
  },
  {
...
EXAMPLE - Upload a PDF document:
{
  ...
  "contentType": "application/pdf"
    ...
    inputSchema: {
      ...
      required: ['baseId', 'recordId', 'fieldIdOrName'],
      additionalProperties: false,
    },
  },
];
